...
class Booking extends CI_Controller
{
    ...
    {
        //mendapatkan stok dan dibooking di tabel buku saat proses booking diselesaikan
    ...
    public function exportToPdf()
    {
        ...
        if ($data1 < 1) {
            $this->session->set_flashdata('pesan', '<div class="alert alert-message alert-danger" role="alert">Tidak Ada Data Booking, Silahkan Lakukan Booking Terlebih Dahulu</div>');
            redirect(base_url());
        } else {
